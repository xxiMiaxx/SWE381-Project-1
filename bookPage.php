...
<nav class="navbar navbar-expand-lg mb-4 top-bar navbar-static-top sps sps--abv">
          ...
          <a class="navbar-brand mx-auto" href="#" style="color:black;">Legacy<span style="margin-right:500px;">Library</span></a>
...
?>
<h3 class="product-title"><?php echo $data['title']; ?></h3>
<div class="rating">
<div class="stars">
        ...
        if($data['status']==0){
          echo '<form>
            <label>BORROW BOOK</label>
             <a href="ownBook.php?id='.$bkId. '" class="add-to-cart btn btn-default"><span class="glyphicon glyphicon-pencil"></span> Borrow Book</a>
          </form>';
